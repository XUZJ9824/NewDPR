// openGlwin32.cpp : Defines the entry point for the application.
//
	...
	int       nCmdShow)
{
	...
	windowClass.lpszClassName = _T("MyClass");
	...
	hwnd = CreateWindowEx(NULL, _T("MyClass"),  //class name
		_T("OpenGL Robot"),       //app name
		dwStyle |
		WS_CLIPCHILDREN |
		WS_CLIPSIBLINGS,
		0, 0,                         //x and y coords
