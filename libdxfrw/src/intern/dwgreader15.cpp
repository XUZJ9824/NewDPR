...
bool dwgReader15::readMetaData() {
    ...
    if (cp == 29) //ansi_1251 Win Russian
    {
        decoder.setCodePage("ANSI_1251", false);
    }
    else if (cp == 30) //ansi_1252 Win Western Europe (ANSI)
    {
        decoder.setCodePage("ANSI_1252", false);
    }
    else if (cp == 39) //ansi_936 Win Simpli
    {
        decoder.setCodePage("ANSI_936", false);
    }
